...
func TestURLPattern(t *testing.T) {
	tests := []struct {
		...
		{"/", false},
		{"http://", false},
		{"http://github.com/BidPal/boilr", true},
		{"https://github.com/BidPal/boilr", true},
		{"github.com/BidPal/boilr", true},
		{"rawcontent.github.com/BidPal/boilr", true},
		{"github.com:80/BidPal/boilr", true},
	}
